...
public class ChatService extends Service {
    ...
    private void handleData(Bundle data) {
        ...
        if (command == CMD_JOIN_CHAT) {
            ...
            int chatMsgDate = date;
            chatMessageStore.insert(new ChatMessage(userName, messageText, chatMsgDate+""));
            ...
            chatMessageStore.insert(new ChatMessage(testUser, testMessage, chatMsgDate+""));
        } else {
